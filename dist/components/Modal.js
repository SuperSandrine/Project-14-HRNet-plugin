...
var Modal = function Modal(props) {
  ...
  var handleParentConditions = function handleParentConditions() {
    ...
    if (dataHref.includes('#') === false) {
      setNewDataHref( /*#__PURE__*/React.createElement(_SpinnerModal.default, null));
      if (!/^data\./.test(ajaxData) | !ajaxData) {
        ...
        .then(function (data) {
          ...
          setNewDataHref( /*#__PURE__*/React.createElement("div", null, func));
        }).catch(function (error) {
          console.error('Il y a eu un problème avec la requête fetch:', error);
          setNewDataHref( /*#__PURE__*/React.createElement("div", null, "\"fetch return error\""));
        });
      }
    }
  };
  ...
  return showModal ? /*#__PURE__*/React.createElement("div", {
    id: "modalBlocker",
    ...
    id: "dialogTitle",
    tabIndex: 1
  }, title), (children || newDataHref) && /*#__PURE__*/React.createElement("div", {
    role: "p",
    className: "tUv39-modalclose-p",
    id: "dialogDesc",
    tabIndex: 2
  }, children, /*#__PURE__*/React.createElement("br", null), newDataHref), closureButton ? /*#__PURE__*/React.createElement("button", {
    onClick: handleModalClose,
    id: "dialogCloseButton",
    className: "tUv39-modalclose-button",
    "aria-label": "close modal button",
    tabIndex: 3
  }, closureButton) : /*#__PURE__*/React.createElement("button", {
    onClick: handleModalClose,
    id: "dialogButton",
